#Exercice n° 5:
#Droits d'utilisateurs pour le manager
#Accès aux ventes de son établissement 
...
#Créer la variable "droits d'auteurs" 
...
#Verifier si les matricules dans b sont bien celles des managers
print (b)

#Renseigner les matricules des managers pour permettre l'accès aux ventes effectuées du bar
in_b = True
while in_b:
